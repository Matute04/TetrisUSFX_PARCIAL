...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APiece_Statics::NewProp_SceneComponent_MetaData[] = {
		{ "Comment", "// macro que declara la variable como una variable que se puede editar en el editor de Unreal Engine.\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Piece.h" },
		{ "ToolTip", "macro que declara la variable como una variable que se puede editar en el editor de Unreal Engine." },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APiece_Statics::NewProp_Colors_MetaData[] = {
		{ "Category", "Piece" },
		{ "Comment", "// significa que la propiedad se puede editar tanto en el editor de Unreal Engine como en el c?digo\n" },
		{ "ModuleRelativePath", "Piece.h" },
		{ "ToolTip", "significa que la propiedad se puede editar tanto en el editor de Unreal Engine como en el c?digo" },
	};
#endif
	...
	IMPLEMENT_CLASS(APiece, 4011097034);

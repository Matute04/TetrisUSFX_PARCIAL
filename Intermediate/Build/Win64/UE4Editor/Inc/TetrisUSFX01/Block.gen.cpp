...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABlock_Statics::NewProp_BlockMesh_MetaData[] = {
		{ "Category", "Block" },
		{ "Comment", "// declara la funci?n Tick que se ejecuta cada fotograma.\n// declara la variable BlockMesh como una variable que se puede editar en el editor de Unreal Engine.\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Block.h" },
		{ "ToolTip", "declara la funci?n Tick que se ejecuta cada fotograma.\ndeclara la variable BlockMesh como una variable que se puede editar en el editor de Unreal Engine." },
	};
#endif
	...
	IMPLEMENT_CLASS(ABlock, 2537096498);
